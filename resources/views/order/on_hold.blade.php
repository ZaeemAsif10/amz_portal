    ...
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">On Hold</h4>
            </div>
            <div class="card-body">

                <form action="{{ url('on_hold') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-3">
                ...
                <div class="float-right mt-3">
                    {{ $data['on_hold']->links('pagination::bootstrap-4') }}
                </div>
