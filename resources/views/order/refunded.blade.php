    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            ...
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Refunded</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('home') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active">Refunded</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Refunded</h4>
            </div>
            <div class="card-body">

                <form action="{{ url('refunded') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-3">
                ...
                <div class="table-responsive mt-5">
                    <table class="table table-nowrap mb-0">
                        ...
                        <tbody id="ordersTable">
                            @if (count($data['refunded']) > 0)
                                @foreach ($data['refunded'] as $key => $order)
                ...
                <div class="float-right mt-3">
                    {{ $data['refunded']->links('pagination::bootstrap-4') }}
                </div>
